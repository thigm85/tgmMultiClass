...
#' 
#' For developers planning to create an interface for their models that uses
#' \code{multiClass}: Make sure that the \code{class_labels} are the same as
#' the one contained in the \code{datasetResample} object used to generate the
#' prediction.
#' 
#' @param class_labels Character vector with the names of the class labels. See details.
...
#' @param datasetResample_tag Character vector representing a tag that connects this
#'  \code{multiClass} object with a data resample object, usually generated by 
#'  functions like \code{generateTestIndexes}
...
multiClass <- function(class_labels, prob, datasetResample_tag, 
                       summary_validation = NULL, metric_name = NULL){
  
  object <- list(class_labels = class_labels, 
                   prob = prob, 
                   datasetResample_tag = datasetResample_tag,
