...
#' This allow us to iidentify what was the exact validation set used to 
#' produce the scores.
#' 
#' @param scores_list List where each element contains a numerical vector with the score
...
#'  \code{\link{summaryValidation}}, 
#'  \code{\link{evaluateProbClass}}
multiClassValidationScores <- function(scores_list, resample_indexes, replicate_index, score_type){
